...
public class DaoUsuario {
	...
	public void guardarPass(Usuario r2, String pass) throws SQLException {
        ...
        String sql = "UPDATE usuarios SET contraseña = '" + pass + "' WHERE nombre = '" + r2.getNombre() + "' AND mail = '" + r2.getMail() + "'";
        PreparedStatement ps = con.prepareStatement(sql);
	...
	public Usuario inicioSesion(Usuario u, String passcifrada) throws SQLException {
        ...
        Usuario aux = new Usuario(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getInt(5),rs.getInt(6), rs.getString(7));
